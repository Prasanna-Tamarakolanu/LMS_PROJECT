...
return Categories.objects.all().order_by('-id')
   ...
   return self.name
    ...
    Level = models.ForeignKey(Level,on_delete=.CASCADE,null=True)
...
class what_you_learn(models.Model):
    course = models.ForeignKey(Course,on_delect=models.CASCADE)
    points =model.CharField(max_length=500)
...
certificate = models.BooleanField(null=True,max_length=100)
def __str__ (self): 
   return self.title
